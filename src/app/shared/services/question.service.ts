...
export class QuestionService {
  private questions: Question[] = [
    new Question(1, "Windows mobile hotspot toggle batch file?", "I want to create a batch file that toggles the mobile hotspot on and off and not disable the setting with regedit. I want to use the in win 11 integrated setting and i...", ["R", "Windows"], 0, 32, 32, "45sec", new User(1,"assets/images/logo.png","fda",331)),
